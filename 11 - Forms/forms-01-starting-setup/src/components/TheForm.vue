<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{ invalid: userNameValidity === 'invalid' }">
      ...
      <!-- lazy specify how Vue update the bound property, on every keystroke or at low frequency -->
      <!-- number force conversion v-model to a string -->
      <!-- trim remove extra white spaces, can be done manually with .trim() method on the methods -->
    ...
    <div class="form-control">
      ...
      <input id="age" name="age" type="number" min="0" v-model="userAge" />
    </div>
    <div class="form-control">
    ...
    <div class="form-control">
      <input type="checkbox" id="confirm-tems"  name="confirm-tems" v-model="confirm" />
